      ...
      <Dialog visible={isVisible} onDismiss={onDismiss} style={styles.dialog}>
        <Dialog.ScrollArea style={styles.scrollArea}>
          <View style={styles.titleContainer}>
            <Title style={styles.title}>امتیازات</Title>
          </View>
          <Separator />
          ...
          <FlatList
            ...
            ListHeaderComponent={() => (
              <View style={styles.listHeader}>
                <ScoreItemText value={"ردیف"} compact />
                <ScoreItemText value={"زمان"} />
                <ScoreItemText value={"تعداد تاس"} />
                <ScoreItemText value={"شماره تاس"} />
              </View>
            )}
          />
        </Dialog.ScrollArea>
        <Dialog.Actions>
          <View style={styles.clearButtonContainer}>
            ...
            >
              <Text style={styles.clearButtonText}>پاک سازی</Text>
            </TouchableRipple>
          </View>
        </Dialog.Actions>
      </Dialog>
